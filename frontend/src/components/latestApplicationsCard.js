...
const LatestApplicationsCard = (props) => {
  ...
  return (
    <div className="h-cardsHeight3 w-cardsWidth3 p-0 m-0 flex flex-col shadow-lg rounded-lg items-center justify-start text-xs"
    >
      <div className="  m-0 w-full h-1/6 flex justify-between items-end">
